...
const BlogPage = () => {
  const [posts, setPosts] = useState([
    ...
    },
    {
      ...
      description:
        "Raising cancer awareness is a crucial step in promoting early detection, providing support for patients, and fostering a culture of prevention. Cancer affects millions of lives globally, and the key to combating it lies in spreading knowledge and understanding.",
      img: "/blog-2.jpg",
    },
    {
      ...
      <div className="container-fluid py-5">
        <div className="container text-center">
          <div className="text-center mx-auto mb-5" style={{ maxWidth: "500px" }}>
            <h5 className="text-blue-600 font-bold uppercase text-4xl">Blog Post</h5>
                  ...
                  <div className="d-flex flex-column align-items-center border-top p-4">
                    ...
                    <div className="d-flex mt-2">
                      <small className="ms-3">
                        <i className="far fa-eye text-primary me-1"></i>1,234
                      </small>
                      <small className="ms-3">
                        <i className="far fa-comment text-primary me-1"></i>45
                      </small>
                    </div>
                  </div>
                </div>
